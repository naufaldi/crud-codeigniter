...
--
-- Host: localhost
-- Generation Time: 04 Des 2017 pada 23.14
...
(1, 'Prestasi', 'UIN Malang', '50', '2017-10-01', '2017-10-24', '2018-10-31', '3', '2017-12-01', 3, NULL, NULL),
(12, 'BRI Prestasi', 'Bank BRI Syariah', '45', '2017-10-01', '2017-11-15', '2018-11-30', '2', '2017-10-01', 3, NULL, 'revisi\r\n'),
(13, 'Beasiswa Putra Daerah', 'rtyui', '8', '2017-10-01', '2017-10-31', '2017-10-31', '3', '2017-10-31', 2, 6, NULL);
...
--
-- Struktur dari tabel `perpus_transaksi_peminjaman`
--

CREATE TABLE `perpus_transaksi_peminjaman` (
  `idPeminjaman` int(11) NOT NULL,
  `no_induk` int(10) DEFAULT NULL,
  `idBuku` int(11) DEFAULT NULL,
  `jumlahPinjam` int(10) DEFAULT NULL,
...
--
-- Dumping data untuk tabel `perpus_transaksi_peminjaman`
--

INSERT INTO `perpus_transaksi_peminjaman` (`idPeminjaman`, `no_induk`, `idBuku`, `jumlahPinjam`, `tanggalPeminjaman`, `tanggalPengembalian`, `denda`, `statusPinjam`) VALUES
(1, 2, 2, 21, '2016-03-12', '2016-03-12', NULL, 0),
(2, 3, 4, 40, '2016-03-12', '2016-03-12', NULL, 0),
(3, 2, 2, 3, '2017-10-23', '2017-10-23', NULL, 0),
(4, 3, 2, 3, '2017-12-04', '2017-12-04', NULL, 0);
...
--
-- Indexes for table `perpus_transaksi_peminjaman`
--
ALTER TABLE `perpus_transaksi_peminjaman`
  ADD PRIMARY KEY (`idPeminjaman`),
  ADD KEY `idSiswa` (`no_induk`),
...
--
-- AUTO_INCREMENT for table `perpus_transaksi_peminjaman`
--
ALTER TABLE `perpus_transaksi_peminjaman`
...
--
ALTER TABLE `identitas_mhs`
  ADD CONSTRAINT `identitas_mhs_ibfk_1` FOREIGN KEY (`idAkses`) REFERENCES `tb_akses` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `profil_admin`
  ADD CONSTRAINT `profil_admin_ibfk_1` FOREIGN KEY (`idAkses`) REFERENCES `tb_akses` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
