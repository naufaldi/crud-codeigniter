...
class Kitab extends CI_Controller {
	...
	{	
		...
		$this->load->view('ustadz/kitab');
		$this->load->view('attribute/footer');
	}
	public function update()
	{	
		$this->load->view('attribute/header_ustadz');
		$this->load->view('ustadz/update_kitab');
		$this->load->view('attribute/footer');
	}
	...
	public function datatable(){
		...
		foreach($fetch_data as $row)
		{
			...
			<a name="edit" id="'.$row->kode_pelajaran.'" href="'.base_url('ustadz/Kitab/ubah_kitab/'.$row->kode_pelajaran).'" title="Edit"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
	...
	public function ubah_kitab($kode_pelajaran)
	{
		...
		$this->load->view('attribute/header_ustadz');
		$this->load->view('ustadz/update_kitab',$data);
		$this->load->view('attribute/footer');
		unset($data);
	}
