...
class C_admin extends CI_Controller {
	...
	public function update(){	
		$this->load->view('attribute/header_admin');
		$this->load->view('admin/update_ustadz');
		$this->load->view('attribute/footer');
	}
	...
	public function datatable(){
		...
		foreach($fetch_data as $row)
		{
			...
			<a name="edit" id="'.$row->kode_ustadz.'" href="'.base_url('admin/C_admin/ubah_ustadz/'.$row->kode_ustadz).'" title="Edit"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
	...
	public function ubah_ustadz($kode_ustadz)
	{
		...
		$this->load->view('attribute/header_admin');
		$this->load->view('admin/update_ustadz',$data);
		$this->load->view('attribute/footer');
		unset($data);
	}
