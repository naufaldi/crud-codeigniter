...
<script type="text/javascript">
    ...
    function datatable() {
        dataTable = $('#tabel').DataTable({
            ...
            "order": [],
            "ajax": {
                url: "<?php echo base_url('ustadz/Kitab/datatable'); ?>",
                type: "POST"
            },
            "columnDefs": [
            {
    ...
    function remove(kode_pelajaran, kitab) {
        ...
        function(isConfirm){
          if (isConfirm){
            $.ajax({
              url : "<?php echo site_url('ustadz/Kitab/delete_data/')?>/"+kode_pelajaran,
              type: "POST",
              dataType: "JSON",
...
<div class="modal fade" id="mdModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo base_url('ustadz/Kitab/tambah_kitab');?>" method="POST">
                <div class="row clearfix">
