            ...
            <div class="card">
                ...
                <div class="body">
                    <div class="table-responsive">
                       <form class="form-horizontal" action="<?php echo base_url('ustadz/Kitab/proses_ubah_kitab');?>" method="POST">
                        <div class="row clearfix">
                        ...
                        <div class="modal-footer">
                            <div class="row clearfix jsdemo-notification-button">
                                ...
                                <a href="<?php echo base_url('ustadz/kitab');?>" class="btn btn-warning">CLOSE</a>
                            </div>
                        </div>
                    </form>
                </div>
