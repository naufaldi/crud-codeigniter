            ...
            <div class="card">
               ...
               <div class="body">
                 <div class="button-demo js-modal-buttons">
                    <button type="button" data-color="light-blue" class="btn btn-lg bg-light-blue waves-effect"><b><i class="glyphicon glyphicon-plus"></i>  TAMBAH USTADZ</b></button>
                </div>
            </div>
            <div class="body">
...
<script type="text/javascript">
    ...
    function datatable() {
        dataTable = $('#tabel').DataTable({
            ...
            "order": [],
            "ajax": {
                url: "<?php echo base_url('admin/C_admin/datatable'); ?>",
                type: "POST"
            },
            "columnDefs": [
            {
    ...
    function remove(kode_ustadz, nama_ustadz) {
        ...
        function(isConfirm){
          if (isConfirm){
            $.ajax({
              url : "<?php echo site_url('admin/C_admin/delete_data/')?>/"+kode_ustadz,
              type: "POST",
              dataType: "JSON",
...
<div class="modal fade" id="mdModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo base_url('admin/C_admin/tambah_ustadz');?>" method="POST">
                <div class="row clearfix">
