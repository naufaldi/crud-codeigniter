...
<script type="text/javascript">
    ...
    function datatable() {
        dataTable = $('#tabel').DataTable({
            ...
            "order": [],
            "ajax": {
                url: "<?php echo base_url('santri/Santri/datatable'); ?>",
                type: "POST"
            },
            "columnDefs": [
            {
    ...
    function remove(kode_ustadz, nama_santri) {
        ...
        function(isConfirm){
          if (isConfirm){
            $.ajax({
              url : "<?php echo site_url('santri/Santri/delete_data/')?>/"+kode_ustadz,
              type: "POST",
              dataType: "JSON",
...
<div class="modal fade" id="mdModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo base_url('santri/Santri/tambah_santri');?>" method="POST">
                <div class="row clearfix">
