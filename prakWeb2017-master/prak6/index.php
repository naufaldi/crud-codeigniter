	...
	<div class="container-fluid">
		...
		<div class="col-md-8">
				<?php 
					...
					elseif(isset($_GET['Laman']) and $_GET['Laman']=='kalkulator'){
			...
			<div class="col-md-4">
				...
				<div class="list-group">
					...
					<a href="?Laman=pendaftaran" class="list-group-item"><span class="glyphicon glyphicon-plus"></span> Pendaftaran</a>
					<a href="?Laman=kalkulator" class="list-group-item"><span class="glyphicon glyphicon-user"></span> Kalkulator</a>
				</div>
			</div>
