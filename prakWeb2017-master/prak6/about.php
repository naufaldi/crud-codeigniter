					...
					<div class="box-body">
						<div class="form-group">
							...
							<div class="input-group col-sm-8">
								<input type="text" class="form-control" id="nama" placeholder="Nama Lengkap" value="Iqbal Fauzi">
						...
						<div class="form-group">
							...
							<div class="input-group col-sm-8">
								<input type="text" class="form-control" id="tempatLahir" placeholder="Tempat Lahir" value="Bojonegoro">
								<span class="input-group-addon">
						...
						<div class="form-group">
							...
							<div class="input-group col-sm-8">
								<input type="date" class="form-control" id="tglLahir" placeholder="Tanggal Lahir" value="07/04/2017">
								<span class="input-group-addon">
						...
						<div class="form-group">
							...
							<div class="input-group col-sm-8">
								<input type="text" class="form-control" id="noTelp" placeholder="Nomor Telephone" value="085735059741">
								<span class="input-group-addon">
